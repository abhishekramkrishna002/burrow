 ...
 */
public class ExpandableNotificationsActivity extends Activity {
    ...
    public ArrayList<Group> SetStandardGroups() {
        ...
        int Images[] = {R.drawable.ic_face_black,R.drawable.ic_face_black, R.drawable.ic_face_black,
                R.drawable.ic_face_black, R.drawable.ic_face_black, R.drawable.ic_face_black,
                R.drawable.ic_face_black,R.drawable.ic_face_black};
