...
public class ExpandableHistoryActivity extends Activity {
    ...
    public ArrayList<Group> SetStandardGroups() {
        ...
        String group_number[] = {"5", "5"};
        String person_names[] = {"Water Alert", "New Plumber", "Lift Damage", "Power Failure", "Footpath", "Electrician", "Play Ground", "Lift"
        };

        int Images[] = {R.drawable.ic_broadcast_black_24dp,R.drawable.ic_broadcast_black_24dp, R.drawable.ic_broadcast_black_24dp,
                R.drawable.ic_broadcast_black_24dp, R.drawable.ic_broadcast_black_24dp, R.drawable.ic_broadcast_black_24dp,
                R.drawable.ic_broadcast_black_24dp,R.drawable.ic_broadcast_black_24dp};
